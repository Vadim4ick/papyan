...
function ServiceCostItem({
  ...
  return (
    ...
    >
      <p className="text-[18px] leading-[23.4px] lg:leading-[22px] font-semibold line-clamp-1">
        {" "}
        {service.title}{" "}
      </p>
      <p className="relative text-[#353535] text-[18px] leading-[22px] font-semibold whitespace-nowrap">
