    ...
    variants: {
      variant: {
        ...
        stroke: `
          ...
          before:transition-transform before:duration-450 before:ease-out hover:before:translate-y-[50%]
          ...
          after:transition-transform after:duration-450 after:ease-out hover:after:-translate-y-[50%]
        `,
        white: `
          h-[40px] w-[182px] 
          text-[13px]
