        ...
        <div className="flex flex-col gap-y-8 justify-between">
          <div className="max-w-[377px] ">
            ...
            <p className="text-[16px] leading-[22px] xl:text-[16px] xl:leading-[22px]">
              Является специалистом по ЛФК, а также работает в сфере ортопедии и
              травматологии. В качестве тренера по лечебной физкультуре он ведет
              работу с пациентами самых разных групп
            </p>
          </div>
