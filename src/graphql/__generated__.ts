...
export type ServicesClinic = {
  ...
  readonly id: Scalars["ID"]["output"];
  readonly servicesClinic: Maybe<
    ReadonlyArray<Maybe<ServicesClinic_ServicesBlock>>
  >;
...
export type ServicesClinic_ServicesBlock_Filter = {
  readonly _and: InputMaybe<
    ReadonlyArray<InputMaybe<ServicesClinic_ServicesBlock_Filter>>
  >;
...
export type GetServiceClinicQuery = {
  readonly __typename?: "Query";
  readonly servicesClinic: {
    readonly __typename?: "servicesClinic";
    readonly servicesClinic: ReadonlyArray<{
      readonly __typename?: "servicesClinic_servicesBlock";
      readonly servicesBlock_id: {
        readonly __typename?: "servicesBlock";
        readonly title: string;
        readonly img: {
          readonly __typename?: "directus_files";
        ...
        readonly allServices: ReadonlyArray<{
          readonly __typename?: "services";
          readonly id: string;
          readonly title: string;
          readonly price: number;
...
export type GetServiceBlockQuery = {
  readonly __typename?: "Query";
  readonly servicesBlock: ReadonlyArray<{
    readonly __typename?: "servicesBlock";
    readonly id: string;
    readonly title: string;
    readonly img: {
...
export function getSdk(
  ...
  return {
    ...
    GetServiceClinic(
      variables?: GetServiceClinicQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetServiceClinicQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetServiceClinicQuery>(
            GetServiceClinicDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetServiceClinic",
    ...
    GetServiceBlock(
      variables?: GetServiceBlockQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetServiceBlockQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetServiceBlockQuery>(
            GetServiceBlockDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "GetServiceBlock",
