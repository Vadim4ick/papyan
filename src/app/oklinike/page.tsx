        ...
        <div className="container mx-auto max-w-[1364px] px-[20px]">
          <div className="flex flex-col xl:flex-row gap-y-[48px] gap-x-[20px] xl:flex-wrap ">
            {cpecialistsList.map((item, index) => (
              <div key={item.id} className={`md:flex ${index % 2 === 1 ? "" : "md:flex-row-reverse"} gap-x-[40px] xl:flex-col-reverse xl:gap-y-[12px]`}>
                <div className="md:w-1/2 xl:w-full">
                  ...
                  <div className="w-full flex flex-col gap-y-[10px] mb-[10px]">
                    <h4 className="md:text-[28px] md:leading-[35px] xl:text-[16px] xl:leading-[22px]">{item.name}</h4>
                    <p className="md:text-[16px] md:leading-[22px] xl:hidden">{item.description}</p>
                  </div>
                </div>
                <div className="items-center relative ] w-[350px] h-[467px] md:w-[357px] md:h-[482px] xl:w-[316px] xl:h-[455px] overflow-hidden rounded-md group">
                  <Image
                    ...
                    className="h-full w-full object-cover"
                  />
                  <div className="absolute top-0 right-0 flex flex-col gap-[8px] p-[8px] z-20">
                    <Button
                      className="h-[48px]"
                      variant="arrow"
